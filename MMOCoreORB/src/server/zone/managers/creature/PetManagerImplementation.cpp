...
short PetManagerImplementation::checkMountEligibility(PetControlDevice* petControlDevice, float height) {
	...
	//Check if the pet's species is able to be trained as a mount REMOVE This For Initial Function To Allow All Pets To Be Mounts Make Sure You Rewrite The Funtion To Allow All Pets To Be Mounts NOTES For Later Reminder
