...
object_tangible_medicine_crafted_medpack_damage_a = object_tangible_medicine_crafted_shared_medpack_damage_a:new {
	...
	experimentalMin = {0, 0, 50, 10, 30, 1000},
	experimentalMax = {0, 0, 100, 20, 15, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 4},

}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_damage_a, "object/tangible/medicine/crafted/medpack_damage_a.iff")