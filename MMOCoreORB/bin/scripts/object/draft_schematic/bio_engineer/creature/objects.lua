...
ObjectTemplates:addClientTemplate(object_draft_schematic_bio_engineer_creature_shared_creature_krayt_dragon, "object/draft_schematic/bio_engineer/creature/shared_creature_krayt_dragon.iff")

object_draft_schematic_bio_engineer_creature_shared_creature_krayt_dragon = SharedDraftSchematicObjectTemplate:new {
	clientTemplateFileName = "object/draft_schematic/bio_engineer/creature/shared_creature_krayt_dragon.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "",
	arrangementDescriptorFilename = "abstract/slot/arrangement/arrangement_datapad.iff",
