...
object_draft_schematic_bio_engineer_creature_creature_ronto = object_draft_schematic_bio_engineer_creature_shared_creature_ronto:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/krayt_dragon_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_krayt_dragon, "object/draft_schematic/bio_engineer/creature/creature_krayt_dragon.iff")
