...
function DathomirStaticSpawnsSwScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "mittens", 60, -821.0, 94.6, -5032.9, 15, 0)
	spawnMobile("dathomir", "mittens", 60, -830.3, 95.0, -5032.0, -25, 0)
	spawnMobile("dathomir", "mittens", 60, -835.5, 95.1, -5022.1, -165, 0)
	spawnMobile("dathomir", "mittens", 60, -825.0, 94.7, -5020.9, -170, 0)
	spawnMobile("dathomir", "mittens", 60, -815.7, 94.3, -5024.5, -160, 0)
