...
function NightSisterStrongholdScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "nightsister_elder_2",600,-3976.1,131.5,-171.3,-169,0)
	spawnMobile("dathomir", "nightsister_elder_2",600,-4003.5,121,-270.1,-54,0)
	spawnMobile("dathomir", "nightsister_elder_2",600,-4155.3,121.0,-99.8,51,0)
	...
	spawnMobile("dathomir", "nightsister_elder_2",600,-5.8,7.2,-3.0,135,189383)
	spawnMobile("dathomir", "nightsister_slave",300,-15.0,7.2,-14.3,3,189384)

	--in the cave
	spawnMobile("dathomir", "axkva_min",600,-90.5,-101,-102.2,172,4115629, true)
