...
function NightSisterStrongholdScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "nightsister_elder2",3600,-3976.1,131.5,-171.3,-169,0)
	spawnMobile("dathomir", "nightsister_elder2",3600,-4003.5,121,-270.1,-54,0)
	spawnMobile("dathomir", "nightsister_elder2",3600,-4155.3,121.0,-99.8,51,0)
	...
	spawnMobile("dathomir", "nightsister_elder2",3600,-5.8,7.2,-3.0,135,189383)
