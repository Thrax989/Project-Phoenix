...
function NabooAmidalasBeachScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "peko_peko_albatross", 300, -1102.14, 7.434, -3979.87, 158, 0)
	spawnMobile("naboo", "peko_peko_albatross", 300,math.random(300) + -1102.14, 7.434,math.random(300) + -3979.87, math.random(360), 0)
	spawnMobile("naboo", "peko_peko_albatross", 300,math.random(300) + -1102.14, 7.434,math.random(300) + -3979.87, math.random(360), 0)
	spawnMobile("naboo", "peko_peko_albatross", 300,math.random(300) + -1102.14, 7.434,math.random(300) + -3979.87, math.random(360), 0)
	spawnMobile("naboo", "peko_peko_albatross", 300,math.random(300) + -1102.14, 7.434,math.random(300) + -3979.87, math.random(360), 0)
	spawnMobile("naboo", "peko_peko_albatross", 300,math.random(300) + -1102.14, 7.434,math.random(300) + -3979.87, math.random(360), 0)
