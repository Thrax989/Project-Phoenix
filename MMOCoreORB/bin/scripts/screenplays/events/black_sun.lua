...
--	spawnMobile("tatooine", "death_watch_miner", 30, -4831.1, 0, -4827.4, -138, 0)
	...
	spawnMobile("tatooine", "black_sun_guard", 90, -3289.0, 0, -4853.5, 168, 0)
...
--Black Sun Headquarters
	...
	spawnMobile("tatooine", "black_sun_assassin", 120, -9.2, 0.6, -12.6, 7, 281475057677302)
...
--Black Sun Medium House
	...
	spawnMobile("tatooine", "black_sun_assassin", 15, 2.1, 0.6, -3.6, -104, 281475057684099)

--Cantina

	spawnMobile("tatooine", "ig_88", 1, 12.4, 1.0, -13.6, -32, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 1, 13.0, 1.0, -12.2, 118, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 30, 12.8, 1.0, -10.1, 87, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, 3.9, 0.5, -16.4, 0, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, -5.6, 0.5, -15.6, 0, 281475001572519)
	spawnMobile("tatooine", "gungi",1, -0.9, 0.5, -15.7, 0, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, 0.4, 0.5, -13.1, 0, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 1, -0.8, 0.5, -11.6, 0, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",	5, -11.5, 1.0, -1.7, -176, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 	5, -11.6, 1.0, -3.6, -25, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 	1, -2.1, 0.8, 5.1, -161, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 	1, 1.5, 0.8, 4.7, 139, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, -12.4, 1.0, -12.0, 85, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, -10.4, 0.8, -14.0, 56, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, -10.5, 0.8, -9.8, 19, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1, -9.6, 0.8, -17, 0, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 1,-12.5, 1, -9.9, 72, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",1,-10.8, 0.9, -10.8, 64, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 1,-3.0, 0.7, 3.3, 17, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin",  1, -0.5, 0.7, 2.4, -5, 281475001572519)
	spawnMobile("tatooine", "cinderclaw",  1, 2.4, 0.7, 3.1, -51, 281475001572519)
	spawnMobile("tatooine", "black_sun_assassin", 1, 4.0, -0.2, -12.6, 173, 281475001572519)
