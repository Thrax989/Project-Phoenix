...
function black_sunScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "ig_88", 11,math.random(210) + -3354.2, 0.0,math.random(210) + -4905.3, math.random(360), 0)
	spawnMobile("tatooine", "gungi", 11,math.random(210) + -3354.2, 0.0,math.random(210) + -4905.3, math.random(360), 0)
	spawnMobile("tatooine", "cinderclaw", 11,math.random(210) + -3354.2, 0.0,math.random(210) + -4905.3, math.random(360), 0)
