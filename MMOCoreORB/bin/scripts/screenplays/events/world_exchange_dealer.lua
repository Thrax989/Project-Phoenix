...
world_exchange = ScreenPlay:new {
   numberOfActs = 1, 
   questString = "world_exchange_task",
   states = {}, 
}
...
world_exchange_convo_handler = Object:new {
   tstring = "conversation_exchange_dealer"
 }

function world_exchange_convo_handler:getNextConversationScreen(conversationTemplate, conversingPlayer, selectedOption)
...
function world_exchange_convo_handler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
