...
--Boss 1 Trigger
	local pPadawan = spawnMobile("yavin4", "som_kenobi_historian_dark_jedi", 3600, 5077.57, 73.6699, 5518.51, 0, 0)
        	createObserver(OBJECTDESTRUCTION, "spirit_exar", "notifyPadawanDead", pPadawan)
--Boss 2 Trigger
	local ppPadawan = spawnMobile("yavin4", "som_kenobi_historian_dark_jedi", 3600, 5077.57, 73.6699, 5525.29, 0, 0)
        	createObserver(OBJECTDESTRUCTION, "spirit_exar", "notifypPadawanDead", ppPadawan)
--Boss 3 Trigger
	local pppPadawan = spawnMobile("yavin4", "som_kenobi_historian_dark_jedi", 3600, 5079.4, 73.6699, 5538.11, 0, 0)
        	createObserver(OBJECTDESTRUCTION, "spirit_exar", "notifyppPadawanDead", pppPadawan)
--Boss 4 Trigger
	local ppppPadawan = spawnMobile("yavin4", "som_kenobi_historian_dark_jedi", 3600, 5077.52, 73.6689, 5550.29, 0, 0)
        	createObserver(OBJECTDESTRUCTION, "spirit_exar", "notifypppPadawanDead", ppppPadawan)
--Boss 5 Trigger
	local pppppPadawan = spawnMobile("yavin4", "som_kenobi_historian_dark_jedi", 3600, 5077.57, 73.6709, 5556.94, 0, 0)
        	createObserver(OBJECTDESTRUCTION, "spirit_exar", "notifyppppPadawanDead", pppppPadawan)


end
--Phase 1 Of 5 Boss Instance [Triggered From "dark_jedi_master", [5077.57, 73.6699, 5518.51,]LOCATION OF TRIGGER]
function spirit_exar:notifyPadawanDead(pPadawan, pKiller)
...
function spirit_exar:notifypPadawanDead(ppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
...
function spirit_exar:notifyppPadawanDead(pppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
...
function spirit_exar:notifypppPadawanDead(ppppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
...
function spirit_exar:notifyppppPadawanDead(pppppPadawan, pKiller)
	local player = LuaCreatureObject(pKiller)
