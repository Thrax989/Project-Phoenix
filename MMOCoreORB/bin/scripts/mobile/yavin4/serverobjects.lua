...
includeFile("yavin4/elliot.lua")
includeFile("yavin4/Mihpisto.lua")
includeFile("yavin4/marvolo.lua")
includeFile("yavin4/mittens.lua")
includeFile("yavin4/Zamidirin.lua")
